      ...
      <main>
        <section id="dnxt-token" className="py-24 bg-dark-dark">
          <div className="container-custom">
            ...
            {/* <div className="mt-8 py-8 px-6 bg-dark-darker rounded-lg border border-gold/20 lg:w-[800px]">
              <h3 className="text-3xl lg:text-4xl font-bold text-white mb-6 hover:text-gold/90 transition-colors duration-300">Book Your Appointment Today</h3>
              <p className="text-diamond-dark mb-4 lg:w-[400px]">
